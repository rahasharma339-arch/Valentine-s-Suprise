(function () {
  ...
  function buildJumbledMessage() {
    ...
    var lines = [
      "Hey " + bf + ", I'm not great with words, but some things need to be said. I like you — genuinely, deeply, in a way that catches me off guard sometimes. I don't know what the future holds for us, but I know I want you in it.",
      "You make me want to be brave enough to see where this goes. No pressure, no expectations — just us, figuring it out together. Because whatever happens, I want to take this journey with you by my side.",
      "Let's write this story together and see where it takes us.",
      '— ' + gf
    ];
